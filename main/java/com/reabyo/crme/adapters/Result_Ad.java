...
public class Result_Ad extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.mail.setText("Email: " + customer.getMail());

        if (columns.size() >= 1 && !customer.getDynamic1().equals(customer.getName())){
            String currentFieldName;
            if (columns.get(0).contains("_")) currentFieldName = columns.get(0).replace("_", " ");
            else currentFieldName = columns.get(0);
            holder.dynamic1.setText(currentFieldName + ": " + customer.getDynamic1());
        ...
        if (columns.size() >= 2){
            String currentFieldName;
            if (columns.get(1).contains("_")) currentFieldName = columns.get(1).replace("_", " ");
            else currentFieldName = columns.get(1);
            holder.dynamic2.setText(currentFieldName + ": " + customer.getDynamic2());
        ...
        if (columns.size() >= 3){
            String currentFieldName;
            if (columns.get(2).contains("_")) currentFieldName = columns.get(2).replace("_", " ");
            else currentFieldName = columns.get(2);
            holder.dynamic3.setText(currentFieldName + ": " + customer.getDynamic3());
        ...
        if (columns.size() >= 4){
            String currentFieldName;
            if (columns.get(3).contains("_")) currentFieldName = columns.get(3).replace("_", " ");
            else currentFieldName = columns.get(3);
            holder.dynamic4.setText(currentFieldName + ": " + customer.getDynamic4());
        ...
        if (columns.size() == 5){
            String currentFieldName;
            if (columns.get(4).contains("_")) currentFieldName = columns.get(4).replace("_", " ");
            else currentFieldName = columns.get(4);
            holder.dynamic5.setText(currentFieldName + ": " + customer.getDynamic5());
