...
public class Activity_Update_Customer extends Activity implements View.OnClickListener, AutoViewBuilder {
    ...
    public void autoViewBuilder() {
        if (results != null) {
            for (int i = 0; i < results.size(); i++) {
                ...
                if (titles.get(i).contains("_")) currentFieldName = titles.get(i).replace("_", " ");
                else currentFieldName = titles.get(i);
                tv.setText(currentFieldName + ": ");
    ...
    public void onClick(View v) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                for (int i = 0; i < currentEdList.length; i++) {
                    ...
                    updatedValues.put(currentFieldName, currentEdList[i]);
                }
        ...
        if (currentEdList != null){
            ...
            if (!currentEdList[2].equals("")) updateCustomerFile.putExtra("updateMail", currentEdList[2]);
