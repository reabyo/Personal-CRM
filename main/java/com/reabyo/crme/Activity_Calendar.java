...
import com.reabyo.crme.adapters.Calendar_Ad;
...
public class Activity_Calendar extends FragmentActivity implements EasyPermissions.PermissionCallbacks, View.OnClickListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        progressDialog.setContentView(R.layout.calendar_progress_dialog);
