        ...
        new AsyncTask<Void, Void, String[]>() {
            ...
            protected void onPostExecute(String[] columnsNames) {
                ...
                for (int i = 0; i < columnsToShow.size(); i++) {
                    ...
                    allButton.setBackgroundResource(R.drawable.button_style);
                    allButton.setPadding(0, 0, 4, 0);
                    String currentFieldName;
                    if (columnsToShow.get(i).contains("_")) currentFieldName = columnsToShow.get(i).replace("_", " ");
                    else currentFieldName = columnsToShow.get(i);
                    autoTextView.setText(currentFieldName + ":" + " ");
                    ...
                    allButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            String currentFieldName;
                            if (splitName[0].contains(" ")) currentFieldName = splitName[0].replace(" ", "_");
                            else currentFieldName = splitName[0];
                            getAllData(currentFieldName);
                        }
                    });
